...
const CardTest = () => {
    ...
    useEffect(() => {
      axios.get('https://wishlists-api-annelund.vercel.app/test')
        .then((res) => {
          setData(res.data)
        })
    }, [])
...
<div style={role_id === 7 ? {'display': 'none'} : {'display': 'block'}}> 
{wish.købt === 1 ? 
                    ...
                    <div>
                      ...
                      <button onClick={() => {
                        ...
                        const payload = {id: wish.id,købt: 1};
                         axios.put(`https://wishlists-api-annelund.vercel.app/test`, payload)
                          .then((res) => {
                            console.log(res)
...
const payload = {
  ...
  axios.delete(`https://wishlists-api-annelund.vercel.app/test`, payload)
  .then((res) => {
 console.log(res)
