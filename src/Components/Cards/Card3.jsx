...
const Card3 = () => {
  ...
  useEffect(() => {
    axios.get("https://wishlists-api-annelund.vercel.app/member3").then((res) => {
      setData(res.data);
    });
  }, []);
        ...
        return (
          <StyledCard key={wish.id} style={role_id !== 3 && wish.købt === 1 ? { opacity: "30%" } : null}>
            ...
            <figcaption>
              ...
              <div style={role_id === 3 ? { display: "none" } : { display: "block" }}>
                {wish.købt === 1 ? (
                          ...
                          <div>
                            ...
                            <button
                              onClick={() => {
                                ...
                                axios.put(`https://wishlists-api-annelund.vercel.app/member3`, payload).then((res) => {
                                  console.log(res);
                ...
                <div className="update">
                  <NoButton
                    ...
                    onClick={() => {
                      ...
                      axios.delete(`https://wishlists-api-annelund.vercel.app/member3`, payload).then((res) => {
