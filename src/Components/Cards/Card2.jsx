...
const Card2 = () => {
  ...
  useEffect(() => {
    axios.get("https://wishlists-api-annelund.vercel.app/member2").then((res) => {
      setData(res.data);
    });
  }, []);
  ...
  return (
    <>
      ...
      {data?.map((wish) => {
        return (
          <StyledCard key={wish.id} style={role_id !== 2 && wish.købt === 1 ? { opacity: "30%" } : null}>
            <picture>
                          ...
                          <div>
                            ...
                            <button
                              onClick={() => {
                                ...
                                axios.put(`https://wishlists-api-annelund.vercel.app/member2`, payload).then((res) => {
                                  console.log(res);
                ...
                <div className="update">
                  <NoButton
                    ...
                    onClick={() => {
                      ...
                      axios.delete(`https://wishlists-api-annelund.vercel.app/member2`, payload).then((res) => {
