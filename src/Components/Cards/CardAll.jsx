...
const CardAll = () => {
  ...
  useEffect(() => {
    axios.get("https://wishlists-api-annelund.vercel.app/allmembers").then((res) => {
      setData(res.data);
    });
  }, []);
  ...
  return (
    <>
      ...
      {data?.map((wish) => {
        return (
          <StyledCard key={wish.id} style={role_id > 4 && wish.købt === 1 ? { opacity: "30%" } : null}>
            <picture>
                          ...
                          <div>
                            ...
                            <button
                              onClick={() => {
                                ...
                                axios.put(`https://wishlists-api-annelund.vercel.app/allmembers`, payload).then((res) => {
                                  console.log(res);
                ...
                <div className="update">
                  <NoButton
                    ...
                    onClick={() => {
                      ...
                      axios.delete(`https://wishlists-api-annelund.vercel.app/allmembers`, payload).then((res) => {
                        console.log(res);
