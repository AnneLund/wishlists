...
useEffect(() => {
  fetch("https://wishlists-api-annelund.vercel.app/allmembers/" + id)
    .then((res) => res.json())
    .then((data) => {
      setData(data.data)
    })
...
const {reset} = useForm();
    ...
    const onSubmit = (id) => {
       const data = {
        ...
        Axios.put('https://wishlists-api-annelund.vercel.app/allmembers', data)
      .then(response => {
...
export default AllMembersUpdate;
