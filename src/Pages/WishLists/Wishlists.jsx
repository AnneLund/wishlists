...
@media screen and (max-width: 600px) {
    .mikkel, .anne, .valdemar, .rebecca, .allmembers{
        width: 90vw;
       div{
       height: 15vh; 
       width: 80vw;
...
<section className='rebecca'>
  <Link to="/rebecca"> 
   <div>
     ...
     {role_id === 5 ? <p>Min ønskeseddel</p> :  <p>
...
<section className='valdemar'>
  <Link to="/valdemar"> 
   <div>
     ...
     {role_id === 6 ? <p>Min ønskeseddel</p> :  <p>
 ...
 <section className='mikkel'>
  <Link to="/mikkel"> 
   <div>
     ...
     {role_id === 4 ? <p>Min ønskeseddel</p> :  <p>
                 Mikkels ønskeseddel
                 </p>}
         </li>  
   </div>
 ...
 <section className='anne'>
  <Link to="/anne"> 
   <div>
     <li>
            {role_id === 3 ? <p>Min ønskeseddel</p> :  <p>
                 Annes ønskeseddel
                 </p>}
 ...
 <section className='allmembers'>
  <Link to="/allmembers"> 
   <div>
     ...
     {role_id === 5 ? <p>Vores ønskeseddel</p> :  <p>
                 Fælles ønskeseddel
                 </p>}
         ...
         : <WishListsPage><h1><Link to="/login">Log ind</Link> for at se denne side</h1></WishListsPage>}
